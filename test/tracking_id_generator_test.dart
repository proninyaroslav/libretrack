...
void main() {
  group('Tracking ID generator |', () {
    late TrackingIdGenerator generator;

    setUpAll(() async {
      await initInjector(Env.test);
      generator = getIt<TrackingIdGenerator>();
    });

    test('Random unique', () {
      final idSet = <TrackingId>{};
      const size = 100;
      for (var i = 0; i < size; i++) {
        idSet.add(generator.randomUnique());
      }
