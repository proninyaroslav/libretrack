...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(howMany) =>
      "{combien, pluriel, un {Etes-vous sûr de vouloir supprimer le paquet sélectionné?} autre {Etes-vous sûr de vouloir supprimer le paquet sélectionné?}}";

  static String m3(howMany) =>
      "{combien, pluriel, un {Échec de la suppression du paquet} autre {Échec de la suppression du paquet}}";

  static String m4(value) => "${value} gal";

  static String m5(error) => "Impossible de générer un code-barres: ${error}";

  static String m6(value) => "${value} h.";

  static String m7(value) => "${value} kg";

  static String m8(date) => "Dernier suivi: ${date}";

  static String m9(value) => "${value} L";

  static String m10(howMany) =>
      "{combien, pluriel, un {Impossible de marquer le paquet comme lu} autre {Impossible de marquer le paquet comme lu}}";

  static String m11(value) => "${value} min.";

  static String m12(howMany) =>
      "{combien, pluriel, un {Échec du déplacement du paquet} autre {Échec du déplacement du paquet}}";

  static String m13(value) => "${value} oz";

  static String m14(date) => "Paquet livré le ${date}";

  static String m15(days) =>
      "{jours, pluriel, zéro {Paquet en transit ${days} jours} un {Paquet en transit ${days} jour} quelques {Paquet en transit ${days} jours} beaucoup de {Package in transit ${days} days} other {Paquet en transit ${days} jours}}";

  static String m16(name) => "Signé par: ${name}";

  static String m17(time) =>
      "Le suivi n\'est pas disponible, car un peu de temps s\'est écoulé depuis le dernier suivi. Veuillez réessayer après ${time}";
  ...
  static String m21(howMany) =>
      "{combien, pluriel, un {Échec du rafraîchissement du paquet} autre {Échec du rafraîchissement du paquet}}";

  static String m22(value) => "${value} sec.";

  static String m23(count) => "Sélectionné: ${count}";

  static String m24(time) => "Pas plus d\'une fois tous les ${time}";
  ...
  static String m28(date) => "Début du suivi: ${date}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activateAndRefresh":
            MessageLookupByLibrary.simpleMessage("Activer et rafraîchir"),
        "activateTracking":
            MessageLookupByLibrary.simpleMessage("Activer le suivi"),
        "activateTrackingFailed": MessageLookupByLibrary.simpleMessage(
            "Échec de l\'activation du suivi"),
        "activeParcels": MessageLookupByLibrary.simpleMessage("Actif"),
        "activityHistory":
            MessageLookupByLibrary.simpleMessage("Historique des activités"),
        "add": MessageLookupByLibrary.simpleMessage("Ajouter"),
        "addAccount": MessageLookupByLibrary.simpleMessage("Ajouter un compte"),
        "addAccountFailed": MessageLookupByLibrary.simpleMessage(
            "Échec de l\'ajout d\'un compte"),
        "addAccountTip": MessageLookupByLibrary.simpleMessage(
            "Avant de tracer les paquets, vous devez ajouter un compte"),
        "addParcels":
            MessageLookupByLibrary.simpleMessage("Ajouter des paquets"),
        "addParcelsFailed": MessageLookupByLibrary.simpleMessage(
            "Échec de l\'ajout de paquets"),
        "addToMyParcels":
            MessageLookupByLibrary.simpleMessage("Ajouter à mes forfaits"),
        "all": MessageLookupByLibrary.simpleMessage("Tout"),
        "allAccountsAlreadyAdded": MessageLookupByLibrary.simpleMessage(
            "Tous les comptes ont déjà été ajoutés"),
        ...
        "appLicense": MessageLookupByLibrary.simpleMessage(
            "LibreTrack est un logiciel libre et gratuit (FOSS), publié selon les termes de la GNU General Public License v3 (GPLv3) https://www.gnu.org/licenses/gpl-3.0.html"),
        ...
        "barcodeScanFailed": MessageLookupByLibrary.simpleMessage(
            "Impossible de scanner le code-barres"),
        "barcodeScanner":
            MessageLookupByLibrary.simpleMessage("Scanner de code-barres"),
        "barrelUnitShort": m0,
        ...
        "companyName":
            MessageLookupByLibrary.simpleMessage("Nom de la société"),
        "copiedToClipboard": MessageLookupByLibrary.simpleMessage(
            "Copié dans le presse-papiers"),
        "copyTrackNumber":
            MessageLookupByLibrary.simpleMessage("Copie du numéro de suivi"),
        ...
        "deleteAccountDialogMsg": MessageLookupByLibrary.simpleMessage(
            "Etes-vous sûr de vouloir supprimer le compte sélectionné?"),
        ...
        "generateBarcode":
            MessageLookupByLibrary.simpleMessage("Générer un code-barres"),
        ...
        "moveToActive":
            MessageLookupByLibrary.simpleMessage("Passer à l\'actif"),
        "moveToArchive":
            MessageLookupByLibrary.simpleMessage("Déplacer vers les archives"),
        ...
        "noTrackingHistory":
            MessageLookupByLibrary.simpleMessage("Pas d\'historique de suivi"),
        "open": MessageLookupByLibrary.simpleMessage("Ouvrir"),
        "openDetails":
            MessageLookupByLibrary.simpleMessage("Ouvrir les détails"),
        ...
        "parcelDetailsHardErrorOccurred": MessageLookupByLibrary.simpleMessage(
            "Une erreur matérielle s\'est produite, le suivi de certains services s\'est arrêté. Vérifiez les erreurs avant d\'activer le suivi"),
        "parcelInTransitStatus": m15,
        "parcelInfo":
            MessageLookupByLibrary.simpleMessage("Informations sur le paquet"),
        "parcelInfoNotAvailableStatus": MessageLookupByLibrary.simpleMessage(
            "Il n\'y a pas encore d\'informations sur le colis. Après l\'envoi d\'un paquet, il peut s\'écouler plusieurs jours avant que l\'on puisse le suivre."),
        ...
        "parcelNamesFieldHint":
            MessageLookupByLibrary.simpleMessage("Optionnel. Un par ligne"),
        "parcelNotFound":
        ...
        "parcelsListHardErrorOccurred": MessageLookupByLibrary.simpleMessage(
            "Une erreur matérielle s\'est produite, le suivi s\'est arrêté. Veuillez vérifier les détails à l\'intérieur"),
        ...
        "parcelsTrackingNotifyChannelTitle":
            MessageLookupByLibrary.simpleMessage("Suivi des paquets"),
        ...
        "parcelsTrackingNotifyInboxStyleTitle":
            MessageLookupByLibrary.simpleMessage("Suivi des colis"),
        ...
        "settingsAppearance":
            MessageLookupByLibrary.simpleMessage("Apparition"),
        "settingsAutoTracking":
            MessageLookupByLibrary.simpleMessage("Suivi automatique"),
        "settingsAutoTrackingFreq":
            MessageLookupByLibrary.simpleMessage("Fréquence de suivi"),
        ...
        "settingsAutoTrackingFreqOneDay":
            MessageLookupByLibrary.simpleMessage("Une fois par jour"),
        "settingsAutoTrackingFreqOneWeek":
            MessageLookupByLibrary.simpleMessage("Une fois par semaine"),
        "settingsAutoTrackingFreqSixHours":
            MessageLookupByLibrary.simpleMessage("Toutes les 6 heures"),
        "settingsAutoTrackingFreqThreeDays":
            MessageLookupByLibrary.simpleMessage("Tous les 3 jours"),
        "settingsAutoTrackingFreqTwelveHours":
            MessageLookupByLibrary.simpleMessage("Toutes les 12 heures"),
        "settingsBehavior":
            MessageLookupByLibrary.simpleMessage("Comportement"),
        "settingsDesktopSection":
            MessageLookupByLibrary.simpleMessage("Poste de travail"),
        "settingsLanguage": MessageLookupByLibrary.simpleMessage("Langage"),
        "settingsNotificationsSection": MessageLookupByLibrary.simpleMessage(
            "Paramètres des notifications"),
        "settingsSystemLanguageOption":
            MessageLookupByLibrary.simpleMessage("Système"),
        "settingsSystemTrayIcon":
            MessageLookupByLibrary.simpleMessage("Icône de barre de système"),
        ...
        "settingsTrackingFreqLimit": MessageLookupByLibrary.simpleMessage(
            "Limite de la fréquence de poursuite"),
        ...
        "settingsTrackingHistorySize": MessageLookupByLibrary.simpleMessage(
        ...
        "settingsTrackingSection":
            MessageLookupByLibrary.simpleMessage("Paramètres de suivi"),
        "share": MessageLookupByLibrary.simpleMessage("Partager"),
        "shareFailed":
            MessageLookupByLibrary.simpleMessage("Impossible de partager"),
        "shipmentAdditionalRateFee":
            MessageLookupByLibrary.simpleMessage("Tarif supplémentaire"),
        "shipmentAlternateTrackingNumber":
            MessageLookupByLibrary.simpleMessage("Autre numéro de suivi"),
        "shipmentCashOnDelivery":
            MessageLookupByLibrary.simpleMessage("Paiement à la livraison"),
        "shipmentCustomDuty":
            MessageLookupByLibrary.simpleMessage("Droit de douane"),
        "shipmentDeclaredValue":
            MessageLookupByLibrary.simpleMessage("Valeur déclarée"),
        "shipmentDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Date de livraison"),
        "shipmentEstimatedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Date de livraison estimée"),
        "shipmentInsuranceRateFee":
            MessageLookupByLibrary.simpleMessage("Frais de taux d\'assurance"),
        "shipmentPickupDate":
            MessageLookupByLibrary.simpleMessage("Date d\'enlèvement"),
        ...
        "shipmentShipperAddress":
            MessageLookupByLibrary.simpleMessage("Adresse de l\'expéditeur"),
        ...
        "shipmentTypeDescription":
            MessageLookupByLibrary.simpleMessage("Type d\'expédition"),
        ...
        "showErrors":
            MessageLookupByLibrary.simpleMessage("Afficher les erreurs"),
        ...
        "sortDateAddedAsc": MessageLookupByLibrary.simpleMessage(
            "Date d\'ajout (la plus récente en premier)"),
        ...
        "statusArrivedAtCustoms":
            MessageLookupByLibrary.simpleMessage("Arrivée aux douanes"),
        "statusCustomsClearanceComplete":
            MessageLookupByLibrary.simpleMessage("Dédouanement terminé"),
        "statusDelivered": MessageLookupByLibrary.simpleMessage("Livré"),
        "statusExportedFromDepartureCountry":
            MessageLookupByLibrary.simpleMessage("Exporté du pays de départ"),
        "statusImportedToDestinationCountry":
            MessageLookupByLibrary.simpleMessage(
                "Importé dans le pays de destination"),
        ...
        "statusInTransitArrivedWaypoint":
            MessageLookupByLibrary.simpleMessage("Arrivé au point de passage"),
        "statusInTransitDepartedWaypoint":
            MessageLookupByLibrary.simpleMessage("Départ du point de passage"),
        "statusInfoReceived":
            MessageLookupByLibrary.simpleMessage("Infos reçues"),
        "statusNotAvailable": MessageLookupByLibrary.simpleMessage(
            "Pas encore d\'informations sur le suivi"),
        ...
        "statusReturnedToShipper":
            MessageLookupByLibrary.simpleMessage("Renvoyé à l\'expéditeur"),
        "track": MessageLookupByLibrary.simpleMessage("Trace"),
        "trackingError":
            MessageLookupByLibrary.simpleMessage("Erreur de suivi"),
        ...
        "trackingErrorInvalidTrackNumber":
            MessageLookupByLibrary.simpleMessage("Numéro de suivi non valide"),
        "trackingErrorMissingAccount": MessageLookupByLibrary.simpleMessage(
            "Le compte est absent. Vérifiez si le compte a été ajouté et s\'il prend en charge le service postal sélectionné."),
        "trackingErrorMissingAuthData": MessageLookupByLibrary.simpleMessage(
            "Données d\'autorisation manquantes. Vérifiez si vous avez un compte et si les données sont correctes."),
        "trackingErrorNetwork":
            MessageLookupByLibrary.simpleMessage("Erreur de réseau"),
        ...
        "trackingErrorOccured": MessageLookupByLibrary.simpleMessage(
            "Une erreur s\'est produite lors du suivi des paquets suivants:"),
        "trackingErrorReason": MessageLookupByLibrary.simpleMessage("Raison"),
        "trackingErrorService": MessageLookupByLibrary.simpleMessage(
            "Le service a renvoyé une erreur"),
        "trackingErrorStackTrace":
            MessageLookupByLibrary.simpleMessage("Trace de pile"),
        "trackingErrorUnknown":
            MessageLookupByLibrary.simpleMessage("Erreur inconnue"),
        "trackingFailed":
            MessageLookupByLibrary.simpleMessage("Le suivi a échoué"),
        "trackingHistory":
            MessageLookupByLibrary.simpleMessage("Historique de suivi"),
        "trackingNumbers":
            MessageLookupByLibrary.simpleMessage("tracage des nombres"),
        "trackingNumbersFieldHint":
            MessageLookupByLibrary.simpleMessage("Un par ligne"),
        "trackingResponseError": MessageLookupByLibrary.simpleMessage("Erreur"),
        "trackingResponseNoInfo":
            MessageLookupByLibrary.simpleMessage("Aucune information"),
        "trackingResponseSuccess":
            MessageLookupByLibrary.simpleMessage("Avec succès"),
        "trackingStartedDate": m28,
        "trackingStoppedStatus": MessageLookupByLibrary.simpleMessage(
            "Suivi arrêté. Le suivi s\'arrête s\'il y a eu une erreur matérielle, ou si le service postal a signalé que les autres statuts ne sont pas fournis."),
