...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "activateAndRefresh" : MessageLookupByLibrary.simpleMessage("Aktivovať a obnoviť"),
    "activateTracking" : MessageLookupByLibrary.simpleMessage("Aktivovať sledovanie"),
    "activateTrackingFailed" : MessageLookupByLibrary.simpleMessage("Aktivácia sledovania zlyhala"),
    "activeParcels" : MessageLookupByLibrary.simpleMessage("Aktívne"),
    "activityHistory" : MessageLookupByLibrary.simpleMessage("História aktivít"),
    "add" : MessageLookupByLibrary.simpleMessage("Pridať"),
    "addAccount" : MessageLookupByLibrary.simpleMessage("Pridať účet"),
    "addAccountFailed" : MessageLookupByLibrary.simpleMessage("Pridanie účtu zlyhalo"),
    "addAccountTip" : MessageLookupByLibrary.simpleMessage("Pred sledovaním balíkov musíte pridať účet"),
    "addParcels" : MessageLookupByLibrary.simpleMessage("Pridať balík"),
    "addParcelsFailed" : MessageLookupByLibrary.simpleMessage("Pridanie balíkov zlyhalo"),
    "addToMyParcels" : MessageLookupByLibrary.simpleMessage("Pridať do mojich balíkov"),
    "all" : MessageLookupByLibrary.simpleMessage("Všetky"),
    "allAccountsAlreadyAdded" : MessageLookupByLibrary.simpleMessage("Všetky účty boli pridané"),
    "appChangelogUrl" : MessageLookupByLibrary.simpleMessage("https://github.com/proninyaroslav/libretrack/blob/HEAD/NEWS.md"),
    "appDescription" : MessageLookupByLibrary.simpleMessage("Cross-platformová apka na sledovanie balíkov.\nTu nájdete viac informácii a môžete prispieť: https://github.com/proninyaroslav/libretrack"),
    ...
    "barcodeScanFailed" : MessageLookupByLibrary.simpleMessage("Čítanie kódu zlyhalo"),
    "barcodeScanner" : MessageLookupByLibrary.simpleMessage("Skener čiarových kódov"),
    "barrelUnitShort" : m0,
    ...
    "copiedToClipboard" : MessageLookupByLibrary.simpleMessage("Skopírované do schránky"),
    ...
    "defaultNotifyChannelDescription" : MessageLookupByLibrary.simpleMessage("Všetky upozornenia, ktoré nespadajú do iných kategórií"),
    "defaultNotifyChannelTitle" : MessageLookupByLibrary.simpleMessage("Predvolené"),
    ...
    "editAccountFailed" : MessageLookupByLibrary.simpleMessage("Úprava účtu zlyhala"),
    "editParcelFailed" : MessageLookupByLibrary.simpleMessage("Nepodarilo sa upraviť balík"),
    "enterAuthData" : MessageLookupByLibrary.simpleMessage("Zadajte autorizačné údaje"),
    ...
    "noTrackingHistory" : MessageLookupByLibrary.simpleMessage("Žiadna história"),
    ...
    "parcelMovedToArchiveSuccess" : MessageLookupByLibrary.simpleMessage("Úspešne presunuté do archívu"),
    ...
    "settingsAutoTrackingFreq" : MessageLookupByLibrary.simpleMessage("Frekvencia sledovania"),
    "settingsAutoTrackingFreqDescr" : MessageLookupByLibrary.simpleMessage("Mininálny sledovací interval. Môže sa líšiť kvôli limitom systému (pripojenie na internet, režim spánku, a pod.)"),
    "settingsAutoTrackingFreqOneDay" : MessageLookupByLibrary.simpleMessage("Raz za deň"),
    "settingsAutoTrackingFreqOneWeek" : MessageLookupByLibrary.simpleMessage("Raz za týždeň"),
    "settingsAutoTrackingFreqSixHours" : MessageLookupByLibrary.simpleMessage("Každých 6 hodín"),
    "settingsAutoTrackingFreqThreeDays" : MessageLookupByLibrary.simpleMessage("Každé 3 dni"),
    "settingsAutoTrackingFreqTwelveHours" : MessageLookupByLibrary.simpleMessage("Každých 12 hodín"),
    "settingsBehavior" : MessageLookupByLibrary.simpleMessage("Správanie"),
    "settingsDesktopSection" : MessageLookupByLibrary.simpleMessage("Pracovná plocha"),
    "settingsLanguage" : MessageLookupByLibrary.simpleMessage("Jazyk"),
    "settingsNotificationsSection" : MessageLookupByLibrary.simpleMessage("Nastavenia upozornení"),
    "settingsSystemLanguageOption" : MessageLookupByLibrary.simpleMessage("Systémový"),
    "settingsSystemTrayIcon" : MessageLookupByLibrary.simpleMessage("Ikona v systémovom paneli"),
    ...
    "settingsThemeSystem" : MessageLookupByLibrary.simpleMessage("Systémová"),
    "settingsTrackingErrorNotifications" : MessageLookupByLibrary.simpleMessage("Upozornenia na chyby sledovania"),
    ...
    "settingsTrackingHistorySizeDescr" : MessageLookupByLibrary.simpleMessage("Maximum záznamov v histórii sledovania"),
    "settingsTrackingNotifications" : MessageLookupByLibrary.simpleMessage("Upozornenia sledovania balíkov"),
    "settingsTrackingSection" : MessageLookupByLibrary.simpleMessage("Nastavenie sledovania"),
    "share" : MessageLookupByLibrary.simpleMessage("Zdieľať"),
    "shareFailed" : MessageLookupByLibrary.simpleMessage("Nie je možné zdieľať"),
    "shipmentAdditionalRateFee" : MessageLookupByLibrary.simpleMessage("Dodatočný poplatok"),
    "shipmentAlternateTrackingNumber" : MessageLookupByLibrary.simpleMessage("Alternatívne sledovacie číslo"),
    "shipmentCashOnDelivery" : MessageLookupByLibrary.simpleMessage("Dobierka"),
    "shipmentCustomDuty" : MessageLookupByLibrary.simpleMessage("Colný poplatok"),
    "shipmentDeclaredValue" : MessageLookupByLibrary.simpleMessage("Deklarovaná hodnota"),
    "shipmentDeliveryDate" : MessageLookupByLibrary.simpleMessage("Dátum doručenia"),
    "shipmentEstimatedDeliveryDate" : MessageLookupByLibrary.simpleMessage("Odhadovaný dátum doručenia"),
    "shipmentInsuranceRateFee" : MessageLookupByLibrary.simpleMessage("Poistenie"),
    "shipmentPickupDate" : MessageLookupByLibrary.simpleMessage("Dátum prevzatia"),
    "shipmentReceiver" : MessageLookupByLibrary.simpleMessage("Prijímateľ"),
    "shipmentReceiverAddress" : MessageLookupByLibrary.simpleMessage("Adresa prijímateľa"),
    "shipmentScheduledDeliveryDate" : MessageLookupByLibrary.simpleMessage("Plánovaný dátum doručenia"),
    "shipmentServiceDescription" : MessageLookupByLibrary.simpleMessage("Služba"),
    "shipmentShipper" : MessageLookupByLibrary.simpleMessage("Odosielateľ"),
    "shipmentShipperAddress" : MessageLookupByLibrary.simpleMessage("Adresa odosielateľa"),
    "shipmentShippingRateFee" : MessageLookupByLibrary.simpleMessage("Poštovné"),
    "shipmentSignedBy" : MessageLookupByLibrary.simpleMessage("Podpísal"),
    "shipmentTypeDescription" : MessageLookupByLibrary.simpleMessage("Typ zásielky"),
    ...
    "sortActivityDateAsc" : MessageLookupByLibrary.simpleMessage("Dátum aktivity (od najnovších)"),
    "sortActivityDateDesc" : MessageLookupByLibrary.simpleMessage("Dátum aktivity (od najstarších)"),
    ...
    "statusExportedFromDepartureCountry" : MessageLookupByLibrary.simpleMessage("Exportovaná z krajiny pôvodu"),
    "statusImportedToDestinationCountry" : MessageLookupByLibrary.simpleMessage("Importovaná do krajiny určenia"),
    ...
    "statusInTransitArrivedWaypoint" : MessageLookupByLibrary.simpleMessage("Dorazila do kontrolného bodu"),
    "statusInTransitDepartedWaypoint" : MessageLookupByLibrary.simpleMessage("Vyrazila z kontrolného bodu"),
    "statusInfoReceived" : MessageLookupByLibrary.simpleMessage("Informácie prijaté"),
    "statusNotAvailable" : MessageLookupByLibrary.simpleMessage("Zatiaľ žiadne informácie"),
    "statusNotDelivered" : MessageLookupByLibrary.simpleMessage("Nedoručená"),
    "statusOutForDelivery" : MessageLookupByLibrary.simpleMessage("Na doručení"),
    "statusPickup" : MessageLookupByLibrary.simpleMessage("Prevzatá"),
    "statusReturnedToShipper" : MessageLookupByLibrary.simpleMessage("Vrátená odosielateľovi"),
    "track" : MessageLookupByLibrary.simpleMessage("Sledovať"),
    "trackingError" : MessageLookupByLibrary.simpleMessage("Chyba sledovania"),
    "trackingErrorAuth" : MessageLookupByLibrary.simpleMessage("Chyba autorizácie. Skotrolujte si vaše údaje"),
    "trackingErrorCode" : MessageLookupByLibrary.simpleMessage("Kód"),
    "trackingErrorInvalidTrackNumber" : MessageLookupByLibrary.simpleMessage("Neplatné sledovacie číslo"),
    "trackingErrorMissingAccount" : MessageLookupByLibrary.simpleMessage("Chýba účet. Skontrolujte či bol pridaný a či podporuje túto poštovú službu"),
    "trackingErrorMissingAuthData" : MessageLookupByLibrary.simpleMessage("Chýbajú autorizačné dáta. Skontrolujte či máte pridaný účet a či sú údaje v poriadku"),
    "trackingErrorNetwork" : MessageLookupByLibrary.simpleMessage("Chyba siete"),
    "trackingErrorNoInfo" : MessageLookupByLibrary.simpleMessage("Informácie o sledovaní nedostupné"),
    "trackingErrorNotifyChannelDescription" : MessageLookupByLibrary.simpleMessage("Upozornenia o chybách sledovania balíkov"),
    "trackingErrorNotifyChannelTitle" : MessageLookupByLibrary.simpleMessage("Chyba sledovania"),
    "trackingErrorOccured" : MessageLookupByLibrary.simpleMessage("Nastala chyba pro sledovaní týchto balíkov:"),
    "trackingErrorReason" : MessageLookupByLibrary.simpleMessage("Dôvod"),
    "trackingErrorService" : MessageLookupByLibrary.simpleMessage("Služba vrátila chybu"),
    "trackingErrorStackTrace" : MessageLookupByLibrary.simpleMessage("Záznam stacku"),
    "trackingErrorUnknown" : MessageLookupByLibrary.simpleMessage("Neznáma chyba"),
    "trackingFailed" : MessageLookupByLibrary.simpleMessage("Sledovanie zlyhalo"),
    "trackingHistory" : MessageLookupByLibrary.simpleMessage("História sledovania"),
    "trackingNumbers" : MessageLookupByLibrary.simpleMessage("Sledovacie čisla"),
    "trackingNumbersFieldHint" : MessageLookupByLibrary.simpleMessage("Jedno na riadok."),
    ...
    "upsAddAccountDescription" : MessageLookupByLibrary.simpleMessage("Musíte zadať autorizačné údaje vášho UPS účtu. Získate ich registráciou tu: https://www.ups.com/doapp/signup?loc=sk_SK\nPre získanie prístupového kľúča navštívte tento odkaz: https://www.ups.com/upsdeveloperkit/manageaccesskeys?loc=sk_SK"),
    "username" : MessageLookupByLibrary.simpleMessage("Meno používateľa"),
    "usps" : MessageLookupByLibrary.simpleMessage("USPS"),
    "uspsAddAccountDescription" : MessageLookupByLibrary.simpleMessage("1. Registujte sa na USPS Web Tools API Portal stránke: https://www.usps.com/business/web-tools-apis/web-tools-registration.htm\n2. Počas registrácie, na otázku \"How will you be using the USPS Web Tools?\" odpovedzte \"Exclusively on my Web site\".\n3. Po registrácii dostanete autorizačné údaje na e-mail."),
    "whoDeliveresParcel" : MessageLookupByLibrary.simpleMessage("Kto balík doručuje"),
