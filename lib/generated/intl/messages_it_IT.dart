...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(email, pageUrl) =>
      "Nessuna app di posta elettronica trovata. Puoi copiare manualmente l\'errore e inviarlo a ${email}\non inviare nella pagina del progetto ${pageUrl}";

  static String m2(howMany) =>
      "${Intl.plural(howMany, one: 'Sei sicuro di eliminare il pacco selezionato??', other: 'Sei sicuro di eliminare i pacchi selezionati??')}";

  static String m3(howMany) =>
      "${Intl.plural(howMany, one: 'Impossibile eliminare il pacco', other: 'Impossibile eliminare i pacchi')}";

  static String m4(value) => "${value} gal";

  static String m5(error) => "Impossibile generare il codice a barre: ${error}";

  static String m6(value) => "${value} h.";

  static String m7(value) => "${value} kg";

  static String m8(date) => "Ultimo monitoraggio: ${date}";

  static String m9(value) => "${value} L";

  static String m10(howMany) =>
      "${Intl.plural(howMany, one: 'Impossibile contrassegnare il pacco come letto', other: 'Impossibile contrassegnare i pacchi come letti')}";

  static String m11(value) => "${value} min.";

  static String m12(howMany) =>
      "${Intl.plural(howMany, one: 'Impossibile spostare il pacco', other: 'Impossibile spostare i pacchi')}";

  static String m13(value) => "${value} oz";

  static String m14(date) => "Pacco consegnato il ${date}";

  static String m15(days) =>
      "${Intl.plural(days, zero: 'Pacco in transito ${days} days', one: 'Pacco in transito ${days} day', few: 'Pacco in transito ${days} days', many: 'Pacco in transito ${days} days', other: 'Pacco in transito ${days} days')}";

  static String m16(name) => "Firmato da: ${name}";

  static String m17(time) =>
      "Il monitoraggio non è disponibile perché è trascorso un po\' di tempo dall\'ultimo monitoraggio. Riprova dopo ${time}";
  ...
  static String m21(howMany) =>
      "${Intl.plural(howMany, one: 'Impossibile aggiornare il pacco', other: 'Impossibile aggiornare i pacchi')}";

  static String m22(value) => "${value} sec.";

  static String m23(count) => "Selezionato: ${count}";

  static String m24(time) => "Non più di una volta ogni ${time}";
  ...
  static String m28(date) => "Monitoraggio iniziato: ${date}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activateAndRefresh":
            MessageLookupByLibrary.simpleMessage("Attiva e aggiorna"),
        "activateTracking":
            MessageLookupByLibrary.simpleMessage("Attiva il monitoraggio"),
        "activateTrackingFailed": MessageLookupByLibrary.simpleMessage(
            "Impossibile attivare il monitoraggio"),
        "activeParcels": MessageLookupByLibrary.simpleMessage("Attivo"),
        "activityHistory":
            MessageLookupByLibrary.simpleMessage("Cronologia attività"),
        ...
        "addAccountFailed": MessageLookupByLibrary.simpleMessage(
            "Impossibile aggiungere l\'account"),
        ...
        "addParcelsFailed": MessageLookupByLibrary.simpleMessage(
            "Impossibile aggiungere i pacchi"),
        "addToMyParcels":
            MessageLookupByLibrary.simpleMessage("Aggiungi ai miei pacchi"),
        ...
        "barcodeScanner":
            MessageLookupByLibrary.simpleMessage("Scanner di codici a barre"),
        "barrelUnitShort": m0,
        ...
        "copyTrackNumber": MessageLookupByLibrary.simpleMessage(
            "Copia numero di tracciamento"),
        ...
        "crashDialogMoreDetails":
            MessageLookupByLibrary.simpleMessage("Maggiori dettagli"),
        ...
        "defaultNotifyChannelTitle":
            MessageLookupByLibrary.simpleMessage("Predefinito"),
        ...
        "filtersAndSorting":
            MessageLookupByLibrary.simpleMessage("Filtri e ordinamento"),
        "gallonUnitShort": m4,
        "generateBarcodFailed": m5,
        "generateBarcode":
            MessageLookupByLibrary.simpleMessage("Genera codice a barre"),
        ...
        "moveToActive":
            MessageLookupByLibrary.simpleMessage("Sposta in attivo"),
        "moveToArchive":
            MessageLookupByLibrary.simpleMessage("Sposta in archivio"),
        ...
        "noTrackingHistory": MessageLookupByLibrary.simpleMessage(
            "Nessuna cronologia di monitoraggio"),
        ...
        "parcelInfo":
            MessageLookupByLibrary.simpleMessage("Informazioni sul pacco"),
        ...
        "parcelMovedToActiveSuccess": MessageLookupByLibrary.simpleMessage(
            "Spostato in attivo con successo"),
        "parcelMovedToArchiveSuccess": MessageLookupByLibrary.simpleMessage(
            "Spostato nell\'archivio con successo"),
        "parcelNames":
            MessageLookupByLibrary.simpleMessage("Nomi dei pacchetti"),
        "parcelNamesFieldHint":
            MessageLookupByLibrary.simpleMessage("Opzionale. Uno per riga"),
        "parcelNotFound":
            MessageLookupByLibrary.simpleMessage("Pacco non trovato"),
        "parcelSignedBy": m16,
        ...
        "parcelsTrackingNotifyChannelTitle":
            MessageLookupByLibrary.simpleMessage("Tracciamento dei pacchi"),
        ...
        "parcelsTrackingNotifyInboxStyleTitle":
            MessageLookupByLibrary.simpleMessage("Tracciamento del pacco"),
        "password": MessageLookupByLibrary.simpleMessage("Password"),
        "postalService":
            MessageLookupByLibrary.simpleMessage("Servizio postale"),
        "poundUnitShort": m20,
        ...
        "settingsAutoTracking":
            MessageLookupByLibrary.simpleMessage("Tracciamento automatico"),
        "settingsAutoTrackingFreq":
            MessageLookupByLibrary.simpleMessage("Frequenza di monitoraggio"),
        ...
        "settingsAutoTrackingFreqOneDay":
            MessageLookupByLibrary.simpleMessage("Una volta al giorno"),
        "settingsAutoTrackingFreqOneWeek":
            MessageLookupByLibrary.simpleMessage("Una volta a settimana"),
        "settingsAutoTrackingFreqSixHours":
            MessageLookupByLibrary.simpleMessage("Ogni 6 ore"),
        "settingsAutoTrackingFreqThreeDays":
            MessageLookupByLibrary.simpleMessage("Ogni 3 giorni"),
        "settingsAutoTrackingFreqTwelveHours":
            MessageLookupByLibrary.simpleMessage("Ogni 12 ore"),
        "settingsBehavior":
            MessageLookupByLibrary.simpleMessage("Comportamento"),
        ...
        "settingsSystemTrayIcon": MessageLookupByLibrary.simpleMessage(
        ...
        "settingsTrackingFreqFifteenMin":
            MessageLookupByLibrary.simpleMessage("15 minuti"),
        "settingsTrackingFreqFortyFiveMin":
            MessageLookupByLibrary.simpleMessage("45 minuti"),
        "settingsTrackingFreqLimit": MessageLookupByLibrary.simpleMessage(
            "Limite di frequenza di monitoraggio"),
        ...
        "settingsTrackingSection": MessageLookupByLibrary.simpleMessage(
            "Impostazioni di monitoraggio"),
        "share": MessageLookupByLibrary.simpleMessage("Condividi"),
        "shareFailed":
            MessageLookupByLibrary.simpleMessage("Impossibile condividere"),
        "shipmentAdditionalRateFee":
            MessageLookupByLibrary.simpleMessage("Tariffa aggiuntiva"),
        ...
        "shipmentCustomDuty":
            MessageLookupByLibrary.simpleMessage("Dazio doganale"),
        "shipmentDeclaredValue":
            MessageLookupByLibrary.simpleMessage("Valore dichiarato"),
        "shipmentDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Data di consegna"),
        "shipmentEstimatedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Data stimata di consegna"),
        "shipmentInsuranceRateFee":
            MessageLookupByLibrary.simpleMessage("Tariffa assicurativa"),
        "shipmentPickupDate":
            MessageLookupByLibrary.simpleMessage("Data di ritiro"),
        "shipmentReceiver":
            MessageLookupByLibrary.simpleMessage("Destinatario"),
        "shipmentReceiverAddress":
            MessageLookupByLibrary.simpleMessage("Indirizzo del destinatario"),
        "shipmentScheduledDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Data di consegna prevista"),
        "shipmentServiceDescription":
            MessageLookupByLibrary.simpleMessage("Servizio"),
        "shipmentShipper": MessageLookupByLibrary.simpleMessage("Mittente"),
        "shipmentShipperAddress":
            MessageLookupByLibrary.simpleMessage("Indirizzo del mittente"),
        "shipmentShippingRateFee":
            MessageLookupByLibrary.simpleMessage("Tariffa di spedizione"),
        "shipmentSignedBy": MessageLookupByLibrary.simpleMessage("Firmato da"),
        "shipmentTypeDescription":
            MessageLookupByLibrary.simpleMessage("Tipo di spedizione"),
        ...
        "sortDateAddedAsc": MessageLookupByLibrary.simpleMessage(
            "Data aggiunta (prima la più recente)"),
        "sortDateAddedDesc": MessageLookupByLibrary.simpleMessage(
            "Data aggiunta (prima la più vecchia)"),
        ...
        "statusArrivedAtCustoms":
            MessageLookupByLibrary.simpleMessage("Arrivato in dogana"),
        "statusCustomsClearanceComplete":
            MessageLookupByLibrary.simpleMessage("Sdoganamento completato"),
        ...
        "statusInTransitArrivedWaypoint": MessageLookupByLibrary.simpleMessage(
            "Arrivato al punto di passaggio"),
        "statusInTransitDepartedWaypoint": MessageLookupByLibrary.simpleMessage(
            "Partito dal punto di passaggio"),
        "statusInfoReceived":
            MessageLookupByLibrary.simpleMessage("Informazioni ricevute"),
        "statusNotAvailable": MessageLookupByLibrary.simpleMessage(
            "Nessuna informazione di tracciamento ancora"),
        "statusNotDelivered":
            MessageLookupByLibrary.simpleMessage("Non consegnato"),
        "statusOutForDelivery":
            MessageLookupByLibrary.simpleMessage("In consegna"),
        "statusPickup": MessageLookupByLibrary.simpleMessage("Pickup"),
        "statusReturnedToShipper": MessageLookupByLibrary.simpleMessage(
            "Restituito allo spedizioniere"),
        "track": MessageLookupByLibrary.simpleMessage("Traccia"),
        "trackingError":
            MessageLookupByLibrary.simpleMessage("Errore di tracciamento"),
        ...
        "trackingErrorInvalidTrackNumber": MessageLookupByLibrary.simpleMessage(
        ...
        "trackingErrorNetwork":
            MessageLookupByLibrary.simpleMessage("Errore di rete"),
        ...
        "trackingErrorStackTrace":
            MessageLookupByLibrary.simpleMessage("Traccia dello stack"),
        "trackingErrorUnknown":
            MessageLookupByLibrary.simpleMessage("Errore sconosciuto"),
        "trackingFailed":
            MessageLookupByLibrary.simpleMessage("Monitoraggio non riuscito"),
        "trackingHistory":
            MessageLookupByLibrary.simpleMessage("Cronologia di monitoraggio"),
        "trackingNumbers":
            MessageLookupByLibrary.simpleMessage("Numeri di tracciamento"),
        "trackingNumbersFieldHint":
            MessageLookupByLibrary.simpleMessage("Uno per riga"),
        "trackingResponseError": MessageLookupByLibrary.simpleMessage("Errore"),
        "trackingResponseNoInfo":
            MessageLookupByLibrary.simpleMessage("Nessuna informazione"),
        "trackingResponseSuccess":
            MessageLookupByLibrary.simpleMessage("Con successo"),
        ...
        "whoDeliveresParcel":
            MessageLookupByLibrary.simpleMessage("Chi consegna il pacco"),
