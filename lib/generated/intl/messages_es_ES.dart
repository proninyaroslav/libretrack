...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(email, pageUrl) =>
      "No se ha encontrado ninguna aplicación de correo electrónico. Puedes copiar manualmente el error y enviarlo a ${email}\no enviar a la página del proyecto ${pageUrl}";

  static String m2(howMany) =>
      "${Intl.plural(howMany, one: '¿Está seguro de borrar el paquete seleccionado?', other: '¿Está seguro de borrar los paquetes seleccionados?')}";

  static String m3(howMany) =>
      "${Intl.plural(howMany, one: 'Error al borrar el paquete', other: 'Error al borrar los paquetes')}";

  static String m4(value) => "${value} gal";

  static String m5(error) => "Error al generar el código de barras: ${error}";

  static String m6(value) => "${value} h.";

  static String m7(value) => "${value} kg";

  static String m8(date) => "Último seguimiento: ${date}";

  static String m9(value) => "${value} L";

  static String m10(howMany) =>
      "{howMany, plural, one {{Error al marcar el paquete como leído} other {Error al marcar los paquetes como leídos}}";

  static String m11(value) => "${value} min.";

  static String m12(howMany) =>
      "${Intl.plural(howMany, one: 'Error al mover el paquete', other: 'Error al mover los paquetes')}";

  static String m13(value) => "${value} oz";

  static String m14(date) => "Paquete llevado el ${date}";

  static String m15(days) =>
      "${Intl.plural(days, zero: 'Páquete en transito ${days} días', one: 'Páquete en transito ${days} día', few: 'Páquete en transito ${days} días', many: 'Páquete en transito ${days} días', other: 'Páquete en transito ${days} días')}";

  static String m16(name) => "Firmado por: ${name}";

  static String m17(time) =>
      "El seguimiento no está disponible, porque ha pasado un poco de tiempo desde el último seguimiento. Por favor, inténtelo de nuevo después de ${time}";
  ...
  static String m21(howMany) =>
      "${Intl.plural(howMany, one: 'Error al actualizar el paquete', other: 'Error al actualiza los paquetes')}";

  static String m22(value) => "${value} sec.";

  static String m23(count) => "Seleccionado: ${count}";

  static String m24(time) => "No más de una vez cada ${time}";
  ...
  static String m28(date) => "Seguimiento iniciado: ${date}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activateAndRefresh":
            MessageLookupByLibrary.simpleMessage("Activar y refrescar"),
        "activateTracking":
            MessageLookupByLibrary.simpleMessage("Activar seguimiento"),
        "activateTrackingFailed": MessageLookupByLibrary.simpleMessage(
            "Error al activar el seguimiento"),
        "activeParcels": MessageLookupByLibrary.simpleMessage("Activo"),
        "activityHistory":
            MessageLookupByLibrary.simpleMessage("Historial de actividad"),
        "add": MessageLookupByLibrary.simpleMessage("Añadir"),
        "addAccount": MessageLookupByLibrary.simpleMessage("Añadir cuenta"),
        "addAccountFailed":
            MessageLookupByLibrary.simpleMessage("Error al añadir cuenta"),
        ...
        "addParcelsFailed":
            MessageLookupByLibrary.simpleMessage("Error al añadir paquetes"),
        "addToMyParcels":
            MessageLookupByLibrary.simpleMessage("Añadir a mis paquetes"),
        "all": MessageLookupByLibrary.simpleMessage("Todo"),
        "allAccountsAlreadyAdded": MessageLookupByLibrary.simpleMessage(
            "Ya se han añadido todas las cuentas"),
        ...
        "barcodeScanner":
            MessageLookupByLibrary.simpleMessage("Escáner de código de barras"),
        "barrelUnitShort": m0,
        "cancel": MessageLookupByLibrary.simpleMessage("Cancelar"),
        "changelog": MessageLookupByLibrary.simpleMessage("Lista de cambios"),
        "close": MessageLookupByLibrary.simpleMessage("Cerrar"),
        "copiedToClipboard":
            MessageLookupByLibrary.simpleMessage("Copiado en el portapapeles"),
        "copyTrackNumber": MessageLookupByLibrary.simpleMessage(
            "Copiando número de seguimiento"),
        ...
        "filtersAndSorting":
            MessageLookupByLibrary.simpleMessage("Filtrado y ordenado"),
        "gallonUnitShort": m4,
        "generateBarcodFailed": m5,
        "generateBarcode":
            MessageLookupByLibrary.simpleMessage("Generar código de barras"),
        ...
        "literUnitShort": m9,
        "loadPageFailed":
            MessageLookupByLibrary.simpleMessage("Error al cargar página"),
        ...
        "moveToArchive":
            MessageLookupByLibrary.simpleMessage("Pasar a archivo"),
        ...
        "openLinkFailed":
            MessageLookupByLibrary.simpleMessage("No se pudo abrir el enlace"),
        ...
        "parcelMovedToActiveSuccess":
            MessageLookupByLibrary.simpleMessage("Pasado a activo con éxito"),
        "parcelMovedToArchiveSuccess":
            MessageLookupByLibrary.simpleMessage("Pasado a archivo con éxito"),
        "parcelNames":
            MessageLookupByLibrary.simpleMessage("Nombres de los paquetes"),
        "parcelNamesFieldHint":
            MessageLookupByLibrary.simpleMessage("Opcional. Uno por línea"),
        "parcelNotFound":
            MessageLookupByLibrary.simpleMessage("Paquete no encontrado"),
        "parcelSignedBy": m16,
        ...
        "parcelsTrackingNotifyChannelTitle":
            MessageLookupByLibrary.simpleMessage("Seguimiento de paquetes"),
        ...
        "postalService":
            MessageLookupByLibrary.simpleMessage("Servicio postal"),
        "poundUnitShort": m20,
        ...
        "settingsAutoTracking":
            MessageLookupByLibrary.simpleMessage("Auto-seguimiento"),
        "settingsAutoTrackingFreq":
            MessageLookupByLibrary.simpleMessage("Frecuencia de seguimiento"),
        ...
        "settingsAutoTrackingFreqOneDay":
            MessageLookupByLibrary.simpleMessage("Una vez al día"),
        "settingsAutoTrackingFreqOneWeek":
            MessageLookupByLibrary.simpleMessage("Una vez a la semana"),
        "settingsAutoTrackingFreqSixHours":
            MessageLookupByLibrary.simpleMessage("Cada 6 horas"),
        "settingsAutoTrackingFreqThreeDays":
            MessageLookupByLibrary.simpleMessage("Cada 3 días"),
        "settingsAutoTrackingFreqTwelveHours":
            MessageLookupByLibrary.simpleMessage("Cada 12 horas"),
        "settingsBehavior":
        ...
        "settingsTrackingFreqFifteenMin":
            MessageLookupByLibrary.simpleMessage("15 minutos"),
        "settingsTrackingFreqFortyFiveMin":
            MessageLookupByLibrary.simpleMessage("45 minutos"),
        "settingsTrackingFreqLimit": MessageLookupByLibrary.simpleMessage(
            "Límite de frecuencia de seguimiento"),
        "settingsTrackingFreqLimitSummary": m24,
        "settingsTrackingFreqOneHour":
            MessageLookupByLibrary.simpleMessage("1 hora"),
        "settingsTrackingFreqThirtyMin":
            MessageLookupByLibrary.simpleMessage("30 minutos"),
        ...
        "settingsTrackingSection":
            MessageLookupByLibrary.simpleMessage("Ajustes de seguimiento"),
        ...
        "shipmentCashOnDelivery":
            MessageLookupByLibrary.simpleMessage("Efecivo en entrega"),
        ...
        "shipmentEstimatedDeliveryDate": MessageLookupByLibrary.simpleMessage(
            "Fecha de entrega planificado"),
        "shipmentPickupDate":
            MessageLookupByLibrary.simpleMessage("Fecha de recogida"),
        "shipmentReceiverAddress":
            MessageLookupByLibrary.simpleMessage("Dirección del receptor"),
        "shipmentScheduledDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Fecha de entrega programado"),
        "shipmentServiceDescription":
            MessageLookupByLibrary.simpleMessage("Servicio"),
        "shipmentShipperAddress":
            MessageLookupByLibrary.simpleMessage("Dirección del remitente"),
        "shipmentSignedBy": MessageLookupByLibrary.simpleMessage("Firmado por"),
        "shipmentTypeDescription":
            MessageLookupByLibrary.simpleMessage("Tipo de envío"),
        ...
        "showError":
            MessageLookupByLibrary.simpleMessage("Error de seguimiento"),
        ...
        "sortDateAddedAsc": MessageLookupByLibrary.simpleMessage(
            "Fecha añadida (desde el más reciente)"),
        "sortDateAddedDesc": MessageLookupByLibrary.simpleMessage(
            "Fecha añadida (desde el más antiguo)"),
        ...
        "statusInfoReceived":
            MessageLookupByLibrary.simpleMessage("Info recibido"),
        "statusNotAvailable": MessageLookupByLibrary.simpleMessage(
            "Sin información de seguimiento aún"),
        "statusOutForDelivery":
            MessageLookupByLibrary.simpleMessage("En espera de la entrega"),
        "statusPickup": MessageLookupByLibrary.simpleMessage("Recogida"),
        "statusReturnedToShipper":
            MessageLookupByLibrary.simpleMessage("Devuelto al remitente"),
        ...
        "trackingErrorNetwork":
            MessageLookupByLibrary.simpleMessage("Error de red"),
        ...
        "trackingErrorStackTrace":
            MessageLookupByLibrary.simpleMessage("Seguimiento de pila"),
        "trackingErrorUnknown":
            MessageLookupByLibrary.simpleMessage("Error desconocido"),
        "trackingFailed":
            MessageLookupByLibrary.simpleMessage("Seguimiento fallido"),
        "trackingHistory":
            MessageLookupByLibrary.simpleMessage("Historial de seguimiento"),
        "trackingNumbers":
            MessageLookupByLibrary.simpleMessage("Números de seguimiento"),
        "trackingNumbersFieldHint":
            MessageLookupByLibrary.simpleMessage("Una por línea"),
        "trackingResponseError": MessageLookupByLibrary.simpleMessage("Error"),
        "trackingResponseNoInfo":
            MessageLookupByLibrary.simpleMessage("Sin info"),
        ...
        "whoDeliveresParcel":
            MessageLookupByLibrary.simpleMessage("Quién lleva el paquete"),
